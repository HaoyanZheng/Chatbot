...
chatbot_api_key = "abcdefghijklmnopqrstuvwxyz"
...
chatbot_endpoint = "http://api.qingyunke.com/api.php"
chatbot_headers = {
...
response = requests.get(chatbot_endpoint, headers=chatbot_headers, params=chatbot_params)

# Check the status code of the response
if response.status_code == 200:
    # Get the chatbot's response from the API response
    chatbot_response = response.json()["content"]
